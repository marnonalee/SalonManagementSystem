      ...
      <section>
        ...
        <table class="min-w-full text-sm text-left text-gray-700">
          ...
          <div class="mt-4 px-3 py-1 border border-gray-300 rounded-md inline-flex space-x-1 text-xs font-medium select-none bg-gray-100">
            <?php if ($page > 1): ?>
              <a href="?page=<?php echo $page - 1; ?>" class="px-2 py-1 rounded hover:bg-gray-300 bg-gray-200 text-gray-700">Previous</a>
            <?php endif; ?>

            <?php for ($i = 1; $i <= $total_pages; $i++): ?>
              <a href="?page=<?php echo $i; ?>" class="px-2 py-1 rounded <?php echo $i == $page ? 'bg-blue-600 text-white' : 'bg-gray-200 text-gray-700 hover:bg-gray-300'; ?>">
                <?php echo $i; ?>
              </a>
            <?php endfor; ?>

            <?php if ($page < $total_pages): ?>
              <a href="?page=<?php echo $page + 1; ?>" class="px-2 py-1 rounded hover:bg-gray-300 bg-gray-200 text-gray-700">Next</a>
            <?php endif; ?>
          </div>
